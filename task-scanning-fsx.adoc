...
+
https://["適用於Linux執行個體的AWS安全性群組"^]

+
https://["適用於Windows執行個體的AWS安全性群組"^]
...
在掃描FSXfor ONTAP SfundVolume之前、 https://["您必須設定一個FSX工作環境、並設定磁碟區"^]。
...
https://["瞭解如何在ONTAP BlueXP中探索或建立FSX for Sf更新 檔案系統"^]。
