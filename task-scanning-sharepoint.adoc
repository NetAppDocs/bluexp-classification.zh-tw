...
如果在沒有網際網路存取的站台上安裝Data Sense、則Cloud Manager Connector也必須安裝在同一個站台上、而且無法存取網際網路。 https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-install-connector-onprem-no-internet.html["深入瞭解"^]。
