...
* 對於內部部署 ONTAP 系統， https://docs.netapp.com/us-en/bluexp-ontap-onprem/task-discovering-ontap.html["BlueXP必須探索ONTAP 整個叢集"^]
...
您的需求系統應該已經可在BlueXP的畫版中使用。Cloud Volumes ONTAP對於內部部署的 ONTAP 系統，您必須擁有 https://docs.netapp.com/us-en/bluexp-ontap-onprem/task-discovering-ontap.html["BlueXP會探索這些叢集"^]。
