...
** Rocky Linux 9 （需要 BlueXP 分級版本 1.24 以上）
** Ubuntu 22.04 （需要 BlueXP 分級版本 1.23 以上）
...
https://youtu.be/gE-vrBLSJqw["觀看此影片"] 以瞭解如何安裝 BlueXP 分類。
...
+
請注意、安裝程式會執行預先檢查、以確保您的系統和網路需求已準備就緒、以便順利安裝。 https://youtu.be/UZtn_I0e1Ls["觀看此影片"] 瞭解預先檢查的訊息和影響。
