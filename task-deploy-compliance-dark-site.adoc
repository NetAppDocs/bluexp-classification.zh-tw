...
如果您的離線內部部署站台上尚未安裝Connector、 https://docs.netapp.com/us-en/bluexp-setup-admin/task-quick-start-private-mode.html["部署Connector"^] 現在就在Linux主機上。
...
如果您的離線內部部署站台尚未安裝BlueXP Connector、 https://docs.netapp.com/us-en/bluexp-setup-admin/task-quick-start-private-mode.html["部署Connector"^] 在離線站台的Linux主機上。
...
* 確認您的 BlueXP Connector 軟體已升級至最新的可用版本。 https://docs.netapp.com/us-en/bluexp-setup-admin/task-managing-connectors.html#upgrade-the-connector-when-using-private-mode["請參閱連接器升級步驟"^]。
