...
[]
====
* 注意 * 此資訊僅適用於 BlueXP 分類舊版 1.30 及更早版本。2023 年 12 月（ v1.26.6 ）版本移除使用 Azure Information Protection （ AIP ）標籤整合資料的選項。
...
在管理 AIP 標籤之前、您必須先登入現有的 Azure 帳戶、將 AIP 標籤功能整合至 BlueXP 分類。一旦啟用、您就能在檔案中管理所有人的AIP標籤 link:concept-cloud-compliance.html["資料來源"^] 在您的BlueXP工作區中。
