...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-1.png["一"]探索您要掃描的 Azure NetApp Files 系統
[role="quick-margin-para"]
在掃描 Azure NetApp Files Volume 之前， https://docs.netapp.com/us-en/bluexp-azure-netapp-files/task-quick-start.html["必須設定BlueXP以探索組態"^]。
