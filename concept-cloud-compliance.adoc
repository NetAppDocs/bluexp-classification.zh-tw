...
* 檔案共用（例如 Dell EMC Isilon 、 Pure Storage 、 Nutanix 等）
* 資料庫：
+
...
BlueXP 分類現在可免費使用多達 500 TiB 的資料。不需要分類授權或付費訂閱。如果您想要掃描的資料數量超過 500 TiB 、您可以停用部分原始系統的掃描功能、並掃描新系統、否則將超過 500 TiB 限制。
